...
_0x3:
	...
	.DB  0x0,0x1,0x0,0x6
_0x22:
	.DB  0x30,0x3A,0x48,0x6F,0x6C,0x61,0x2E,0x74
	.DB  0x78,0x74
_0x23:
	.DB  0x4D,0x61,0x6E,0x75,0x65,0x6C,0x20,0x4E
	.DB  0x65,0x72,0x69,0x20,0x41,0x30,0x31,0x37
	.DB  0x30,0x36,0x34,0x35,0x30
_0x0:
	.DB  0x44,0x72,0x69,0x76,0x65,0x20,0x44,0x65
	.DB  0x74,0x65,0x63,0x74,0x61,0x64,0x6F,0x20
	.DB  0x20,0x0,0x41,0x72,0x63,0x68,0x69,0x76
	.DB  0x6F,0x20,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x0,0x45,0x6E,0x63,0x6F,0x6E,0x74
	.DB  0x72,0x61,0x64,0x6F,0x0,0x45,0x6C,0x20
	.DB  0x41,0x72,0x63,0x68,0x69,0x76,0x6F,0x20
	.DB  0x64,0x69,0x63,0x65,0x3A,0x20,0x20,0x20
	.DB  0x0,0x20,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x20,0x20,0x20,0x20,0x0,0x45,0x73
	.DB  0x63,0x72,0x69,0x62,0x69,0x65,0x6E,0x64
	.DB  0x6F,0x20,0x2E,0x2E,0x2E,0x0,0x4C,0x69
	.DB  0x73,0x74,0x6F,0x0,0x41,0x72,0x63,0x68
	.DB  0x69,0x76,0x6F,0x20,0x4E,0x4F,0x20,0x45
	.DB  0x6E,0x63,0x6F,0x6E,0x74,0x72,0x61,0x64
	.DB  0x6F,0x0,0x44,0x72,0x69,0x76,0x65,0x20
...
; .FSTART _timer1_compa_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0017 disk_timerproc();
	CALL _disk_timerproc
; 0000 0018 /* MMC/SD/SD HC card access low level timing function */
; 0000 0019 }
	LD   R30,Y+
	OUT  SREG,R30
	LD   R31,Y+
...
_main:
; .FSTART _main
; 0000 001E     unsigned int  br;
; 0000 001F     char buffer[100];
; 0000 0020 
; 0000 0021     /* FAT function result */
; 0000 0022     FRESULT res;
; 0000 0023 
; 0000 0024     /* will hold the information for logical drive 0: */
; 0000 0025     FATFS drive;
; 0000 0026     FIL archivo; // file objects
; 0000 0027 
...
;	archivo -> Y+0
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 0029     CLKPR=0x01;         //Cambiar a 8MHz la frecuencia de operación del micro
	LDI  R30,LOW(1)
	STS  97,R30
; 0000 002A 
; 0000 002B     // Código para hacer una interrupción periódica cada 10ms
; 0000 002C     // Timer/Counter 1 initialization
; 0000 002D     // Clock source: System Clock
; 0000 002E     // Clock value: 1000.000 kHz
; 0000 002F     // Mode: CTC top=OCR1A
; 0000 0030     // Compare A Match Interrupt: On
; 0000 0031     TCCR1B=0x0A;     //CK/8 10ms con oscilador de 8MHz
	LDI  R30,LOW(10)
	STS  129,R30
; 0000 0032     OCR1AH=0x27;
	LDI  R30,LOW(39)
	STS  137,R30
; 0000 0033     OCR1AL=0x10;
	LDI  R30,LOW(16)
	STS  136,R30
; 0000 0034     TIMSK1=0x02;
	LDI  R30,LOW(2)
	STS  111,R30
; 0000 0035 
; 0000 0036     DDRB.7=1;
...
; 0000 0038     #asm("sei")
	sei
; 0000 0039     /* Inicia el puerto SPI para la SD */
; 0000 003A     disk_initialize(0);
	LDI  R26,LOW(0)
...
; 0000 003B     delay_ms(200);
	...
	CALL _delay_ms
; 0000 003C 
; 0000 003D     /* mount logical drive 0: */
; 0000 003E     if ((res=f_mount(0,&drive))==FR_OK){
	LDI  R30,LOW(0)
	ST   -Y,R30
	MOVW R26,R28
	SUBI R26,LOW(-(545))
	...
	BREQ PC+2
	RJMP _0x26
; 0000 003F         MoveCursor(0,0);
	CALL SUBOPT_0x4
; 0000 0040         StringLCD("Drive Detectado  ");
	__POINTW2FN _0x0,0
	CALL SUBOPT_0x5
; 0000 0041         delay_ms(1500);
; 0000 0042 
; 0000 0043         /*Lectura de Archivo*/
; 0000 0044         res = f_open(&archivo, NombreArchivo, FA_OPEN_ALWAYS | FA_WRITE | FA_READ);
	...
	CALL _f_open
	MOV  R19,R30
; 0000 0045         if (res==FR_OK){
	CPI  R19,0
	BREQ PC+2
	RJMP _0x27
; 0000 0046             MoveCursor(0,0);
	CALL SUBOPT_0x4
; 0000 0047         StringLCD("Archivo        ");
	__POINTW2FN _0x0,18
	CALL SUBOPT_0x6
; 0000 0048             MoveCursor(0,1);
; 0000 0049             StringLCD("Encontrado");
	__POINTW2FN _0x0,34
	CALL SUBOPT_0x5
; 0000 004A             delay_ms(1500);
; 0000 004B 
; 0000 004C             f_read(&archivo, buffer, 10,&br); //leer archivo
	MOVW R30,R28
	SUBI R30,LOW(-(1108))
	SBCI R31,HIGH(-(1108))
	ST   -Y,R31
	...
	POP  R17
; 0000 004D 
; 0000 004E             MoveCursor(0,0);
	CALL SUBOPT_0x4
; 0000 004F             StringLCD("El Archivo dice:   ");
	__POINTW2FN _0x0,45
	CALL SUBOPT_0x6
; 0000 0050             MoveCursor(0,1);
; 0000 0051             StringLCD("                    ");
	__POINTW2FN _0x0,65
	RCALL _StringLCD
...
; 0000 0054             MoveCursor(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _MoveCursor
; 0000 0055             //StringLCDVar(buffer);
; 0000 0056             delay_ms(1500);
	LDI  R26,LOW(1500)
	LDI  R27,HIGH(1500)
	CALL _delay_ms
; 0000 0057 
; 0000 0058             /*Escribiendo en el mismo Arcvhivo*/
; 0000 0059             EraseLCD();
	RCALL _EraseLCD
; 0000 005A             MoveCursor(0,0);
	CALL SUBOPT_0x4
; 0000 005B             StringLCD("Escribiendo ...");
	__POINTW2FN _0x0,86
	RCALL _StringLCD
; 0000 005C 
; 0000 005D             /*Mover el apuntador al final del archivo*/
; 0000 005E 
; 0000 005F             f_lseek(&archivo,archivo.fsize);
	CALL SUBOPT_0x7
	CALL SUBOPT_0x8
	CALL _f_lseek
; 0000 0060 
; 0000 0061             buffer[0] = 0x0D;                //Carriage return
	LDI  R30,LOW(13)
	__PUTB1SX 1106
; 0000 0062             buffer[1] = 0x0A;                //Line Feed
	LDI  R30,LOW(10)
	__PUTB1SX 1107
; 0000 0063             f_write(&archivo,buffer,2,&br);
	CALL SUBOPT_0x7
	MOVW R30,R28
	SUBI R30,LOW(-(1108))
	SBCI R31,HIGH(-(1108))
	...
	POP  R16
	POP  R17
; 0000 0064             /*Escribiendo el Texto*/
; 0000 0065             f_write(&archivo,TextoEscritura,sizeof(TextoEscritura),&br);
	CALL SUBOPT_0x7
	LDI  R30,LOW(_TextoEscritura)
	LDI  R31,HIGH(_TextoEscritura)
	ST   -Y,R31
	ST   -Y,R30
	LDI  R30,LOW(22)
	LDI  R31,HIGH(22)
...
; 0000 0069             EraseLCD();
	RCALL _EraseLCD
; 0000 006A             MoveCursor(0,1);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _MoveCursor
; 0000 006B             StringLCD("Listo");
...
; 0000 006E         else{
	RJMP _0x2A
_0x27:
; 0000 006F             StringLCD("Archivo NO Encontrado");
