...
_0x3:
	...
	.DB  0x0,0x1,0x0,0x6
_0x0:
	.DB  0x50,0x65,0x6F,0x70,0x6C,0x65,0x20,0x43
	.DB  0x6F,0x75,0x6E,0x74,0x65,0x72,0x0,0x25
	.DB  0x69,0x25,0x69,0x25,0x69,0x0
__RESET:
	CLI
	CLR  R30
	OUT  EECR,R30
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 2 TIMES, CODE SIZE REDUCTION:1 WORDS
SUBOPT_0xA:
	LDI  R26,LOW(_centena)
	LDI  R27,HIGH(_centena)
	LD   R30,X+
	LD   R31,X+
	RET
