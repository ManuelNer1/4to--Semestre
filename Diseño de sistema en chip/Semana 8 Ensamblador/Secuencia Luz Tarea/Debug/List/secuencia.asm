...
_0x9:
	...
	.DB  0x2,0x4,0x8,0x10,0x20,0x40
_0xA:
	.DB  0x81,0x42,0x24,0x18,0x24,0x42
_0xB:
	.DB  0x2
...
SUBOPT_0x3:
	LDI  R26,LOW(_acumulador)
	LDI  R27,HIGH(_acumulador)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
