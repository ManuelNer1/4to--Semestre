...
-- Design Ports Information
-- suma	=>  Location: PIN_W3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF fullader IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
\suma~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
-- Equation(s):
-- \inst5~0_combout\ = \A~input_o\ $ (\Cin~input_o\ $ (\B~input_o\))
...
-- Equation(s):
-- \inst3~0_combout\ = (\A~input_o\ & ((\Cin~input_o\) # (\B~input_o\))) # (!\A~input_o\ & (\Cin~input_o\ & \B~input_o\))
