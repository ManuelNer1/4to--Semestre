...
-- Design Ports Information
-- salida[0]	=>  Location: PIN_Y2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- salida[1]	=>  Location: PIN_AA1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- salida[2]	=>  Location: PIN_AA2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- salida[3]	=>  Location: PIN_U7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- entrada[0]	=>  Location: PIN_W3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- entrada[1]	=>  Location: PIN_W4,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF dec2a4process IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Equal0~0_combout\ = (\entrada[0]~input_o\) # (\entrada[1]~input_o\)
...
-- Equation(s):
-- \Equal2~0_combout\ = (\entrada[0]~input_o\ & !\entrada[1]~input_o\)
...
-- Equation(s):
-- \Equal2~1_combout\ = (!\entrada[0]~input_o\ & \entrada[1]~input_o\)
...
-- Equation(s):
-- \Equal2~2_combout\ = (\entrada[0]~input_o\ & \entrada[1]~input_o\)
