...
ENTITY 	adder4bits IS
    PORT (
	a : IN IEEE.STD_LOGIC_ARITH.unsigned(3 DOWNTO 0);
	b : IN IEEE.STD_LOGIC_ARITH.unsigned(3 DOWNTO 0);
	Sum : OUT IEEE.STD_LOGIC_ARITH.unsigned(3 DOWNTO 0)
	);
END adder4bits;

-- Design Ports Information
-- Sum[0]	=>  Location: PIN_B5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- b[1]	=>  Location: PIN_B2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF adder4bits IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
Sum <= IEEE.STD_LOGIC_ARITH.UNSIGNED(ww_Sum);
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;
