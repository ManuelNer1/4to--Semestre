...
-- Design Ports Information
-- salida[0]	=>  Location: PIN_AB6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- salida[1]	=>  Location: PIN_AB7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- salida[2]	=>  Location: PIN_AA7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- entrada[3]	=>  Location: PIN_V9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- entrada[1]	=>  Location: PIN_AB8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- entrada[2]	=>  Location: PIN_AB5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- entrada[0]	=>  Location: PIN_AA6,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF encoder4a2 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \ALT_INV_salida~1_combout\ : std_logic;
...
\ALT_INV_salida~1_combout\ <= NOT \salida~1_combout\;
...
-- Equation(s):
-- \salida~0_combout\ = (\entrada[3]~input_o\) # ((\entrada[1]~input_o\ & !\entrada[2]~input_o\))
...
-- Equation(s):
-- \salida~1_combout\ = (!\entrada[2]~input_o\ & !\entrada[3]~input_o\)
...
-- Equation(s):
-- \salida~2_combout\ = (\entrada[0]~input_o\) # ((\entrada[1]~input_o\) # ((\entrada[2]~input_o\) # (\entrada[3]~input_o\)))
