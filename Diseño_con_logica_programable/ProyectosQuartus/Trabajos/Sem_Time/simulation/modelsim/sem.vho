...
SIGNAL \pres_state.St_Green~feeder_combout\ : std_logic;
SIGNAL \Rst~input_o\ : std_logic;
SIGNAL \StateCount~1_combout\ : std_logic;
...
SIGNAL \Timebase~feeder_combout\ : std_logic;
SIGNAL \Timebase~q\ : std_logic;
SIGNAL \Add2~0_combout\ : std_logic;
SIGNAL \StateCount~0_combout\ : std_logic;
SIGNAL \Equal1~0_combout\ : std_logic;
SIGNAL \StateCount~2_combout\ : std_logic;
SIGNAL \StateCount~3_combout\ : std_logic;
SIGNAL \pres_state~12_combout\ : std_logic;
...
\pres_state.St_Green~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \pres_state.St_Green~feeder_combout\ = \pres_state.St_RedAmber~q\
...
PORT MAP (
	...
	combout => \pres_state.St_Green~feeder_combout\);
...
\StateCount~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \StateCount~1_combout\ = (StateCount(0) & (StateCount(1) $ ((StateCount(2))))) # (!StateCount(0) & (StateCount(2) & ((!\Equal1~0_combout\) # (!StateCount(1)))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (!Cont(8) & (!Cont(9) & (!Cont(7) & Cont(6))))
...
-- Equation(s):
-- \Cont~10_combout\ = (!\Equal0~8_combout\ & \Add0~24_combout\)
...
-- Equation(s):
-- \Equal0~6_combout\ = (Cont(4) & (Cont(3) & (Cont(2) & Cont(5))))
...
\Timebase~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Timebase~feeder_combout\ = \Equal0~8_combout\
...
PORT MAP (
	datad => \Equal0~8_combout\,
	combout => \Timebase~feeder_combout\);
...
-- Equation(s):
-- \Add2~0_combout\ = StateCount(3) $ (((StateCount(0) & (StateCount(1) & StateCount(2)))))
...
\StateCount~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \StateCount~0_combout\ = (\Add2~0_combout\ & (((StateCount(0)) # (!StateCount(1))) # (!\Equal1~0_combout\)))
...
-- Equation(s):
-- \Equal1~0_combout\ = (StateCount(3) & (\pres_state.St_Green~q\ & (StateCount(2) $ (\pres_state.St_RedAmber~q\)))) # (!StateCount(3) & (!\pres_state.St_Green~q\ & (StateCount(2) $ (\pres_state.St_RedAmber~q\))))
...
\StateCount~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \StateCount~2_combout\ = (StateCount(0) & (!StateCount(1))) # (!StateCount(0) & (StateCount(1) & !\Equal1~0_combout\))
...
\StateCount~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \StateCount~3_combout\ = (!StateCount(0) & ((!\Equal1~0_combout\) # (!StateCount(1))))
...
\pres_state~12\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \pres_state~12_combout\ = (!StateCount(0) & (StateCount(1) & (\Timebase~q\ & \Equal1~0_combout\)))
...
PORT MAP (
	clk => \Clk~inputclkctrl_outclk\,
	d => \pres_state.St_Green~feeder_combout\,
	clrn => \ALT_INV_Rst~input_o\,
	ena => \pres_state~12_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
